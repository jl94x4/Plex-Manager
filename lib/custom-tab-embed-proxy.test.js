...
import {
    ...
    buildPathMountedArrAssetTargetUrl,
...
assert.deepEqual(
    parsePathMountedArrFromReferer('https://portal.strymx.co.uk/radarr/', 'https://portal.strymx.co.uk'),
    { arrType: 'radarr', mountSegment: 'radarr' },
);
assert.deepEqual(
    parsePathMountedArrFromReferer('https://portal.strymx.co.uk/lidarr', 'https://portal.strymx.co.uk'),
    { arrType: 'lidarr', mountSegment: 'lidarr' },
);
assert.equal(parsePathMountedArrFromReferer('https://portal.strymx.co.uk/radarr/settings', 'https://portal.strymx.co.uk'), null);
assert.equal(parsePathMountedArrFromReferer('https://evil.example/radarr/', 'https://portal.strymx.co.uk'), null);
...
assert.equal(
    ...
    'https://portal.strymx.co.uk/lidarr/api/v3/system/status',
);
