...
assert.equal(radarr4kTargets[0], 'http://192.168.1.22:7879/index-8c868bd.js');
...
assert.equal(radarr4kPathIntegrationTargets[0], 'http://192.168.1.22:7879/Content/styles.css');
assert.ok(radarr4kPathIntegrationTargets.includes('http://192.168.1.22:7879/radarr4k/Content/styles.css'));

assert.equal(
    resolvePathMountedArrEmbedUpstreamUrl(
        'https://portal.strymx.co.uk/radarr4k',
        'https://portal.strymx.co.uk',
        [{ type: 'radarr4k', enabled: true, url: 'http://192.168.1.22:7879' }],
    ),
    'http://192.168.1.22:7879',
);
