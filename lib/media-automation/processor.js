        ...
        try {
            ...
            for (let index = 0; index < steps.length; index += 1) {
                ...
                try {
                    ...
                    if (!transcode || !settings.allowCpuFallback || step.hardwareAcceleration === 'cpu') throw error;
                    adapter = selectMediaAdapter('cpu', capabilities, String(step.videoCodec || 'h264').toLowerCase());
                    await recordActivity({
