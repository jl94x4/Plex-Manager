...
export const BRANDING_ASSET_NAMES = new Set(['logo', 'background', 'favicon', 'login']);
...
export const parseBrandingPublicPath = (value = '') => {
    ...
    const match = trimmed.match(/^\/static\/(logo|background|favicon|login)\.(png|jpg|jpeg|webp)$/i);
