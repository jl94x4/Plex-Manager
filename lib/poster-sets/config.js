...
export const DEFAULT_POSTER_SETS_CONFIG = {
    ...
    tpdb_username: '',
    tpdb_password: '',
    /** Persist ThePosterDB title/set/image scrapes for fast reopen + offline apply (library titles only). */
...
export const normalizePosterSetsConfig = (input = {}) => {
    ...
    return {
        ...
        tpdbCacheMaxBytes: (() => {
            ...
            return Math.max(256 * 1024 * 1024, Math.min(20 * 1024 * 1024 * 1024, Math.round(raw)));
        })(),
    };
};
