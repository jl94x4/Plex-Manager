...
/**
 * Run poster-sets CLI command. Emits progress via onProgress.
 * @returns {Promise<{ ok: boolean, result?: object, error?: string, logs: string[] }>}
 */
export const runPosterSetsCli = (command, payload = {}, { timeoutMs = 30 * 60_000, onProgress } = {}) => new Promise((resolve) => {
