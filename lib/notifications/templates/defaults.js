...
export const DEFAULT_NOTIFY_TEMPLATES = {
    ...
    scanner_deleted: {
        pushTitle: 'Deleted: {title}',
        pushBody: '{title} was removed from the library.',
        ntfyTitle: 'Deleted: {title}',
        ntfyBody: '{title} was removed from the library.',
        webhookBody: '',
    },
    scanner_upgrade: {
        pushTitle: 'Upgrade: {title}',
        pushBody: '{title} was upgraded.',
        ntfyTitle: 'Upgrade: {title}',
        ntfyBody: '{title} was upgraded.',
        webhookBody: '',
    },
    scanner_import: {
        pushTitle: 'Imported: {title}',
        pushBody: '{title} was imported.',
        ntfyTitle: 'Imported: {title}',
        ntfyBody: '{title} was imported.',
        webhookBody: '',
    },
    status_down: {
