 ...
 * {season} {server_name} {decline_reason} {filename}
 */
...
export const DEFAULT_NOTIFY_TEMPLATES = {
    ...
    scanner_deleted: {
        pushTitle: 'Scanner Notification',
        pushBody: 'Deleted: {title}',
        ntfyTitle: 'Scanner Notification',
        ntfyBody: 'Deleted: {title}',
        webhookBody: '',
    },
    scanner_upgrade: {
        pushTitle: 'Scanner Notification',
        pushBody: 'Upgraded: {title}',
        ntfyTitle: 'Scanner Notification',
        ntfyBody: 'Upgraded: {title}',
        webhookBody: '',
    },
    scanner_import: {
        pushTitle: 'Scanner Notification',
        pushBody: 'Imported: {title}',
        ntfyTitle: 'Scanner Notification',
        ntfyBody: 'Imported: {title}',
        webhookBody: '',
    },
    scanner_grab: {
        pushTitle: 'Scanner Notification',
        pushBody: 'Grabbed: {filename}',
        ntfyTitle: 'Scanner Notification',
        ntfyBody: 'Grabbed: {filename}',
        webhookBody: '',
    },
    scanner_update: {
        pushTitle: 'Scanner Notification',
        ...
        ntfyTitle: 'Scanner Notification',
        ntfyBody: 'Updated: {title}',
        webhookBody: '',
    },
    scanner_interaction: {
        pushTitle: 'Scanner Notification',
        pushBody: 'Needs attention: {filename}',
        ntfyTitle: 'Scanner Notification',
        ntfyBody: 'Needs attention: {filename}',
        webhookBody: '',
    },
    status_down: {
