...
type SearchResultProps = {
    ...
    /** Site + user allow the hero now-playing strip. */
    ...
    return (
        <>
            <div className={discoveryTheme.heroShell}>
                <div className="absolute inset-0 z-0 rounded-2xl overflow-hidden bg-gradient-to-br from-plex/20 to-background/80">
                ...
                <div className={`relative z-10 p-6 sm:p-10 flex flex-col items-center justify-center text-center gap-4 sm:gap-5 ${nowPlaying ? 'pb-4 sm:pb-5' : ''}`}>
