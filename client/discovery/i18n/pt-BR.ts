...
Object.assign(ptBR, { settings: { ...ptBR.settings, notifications: {
    ...
    events: { available: 'Disponível', approved: 'Aprovada', declined: 'Recusada', season: 'Temporada', episode: 'Novo episódio', admin_pending: 'Pendente do admin', collexions_failed: 'Falha no ColleXions', scanner_failed: 'Falha no Scanner', status_down: 'Status fora do ar', status_up: 'Status recuperado', media_job_failed: 'Job do Media Automation falhou', media_job_completed: 'Job do Media Automation concluído' },
