...
export const pl: DeepPartial<EnCatalog> = {
    downloads: { page: { eyebrow: 'Pobieranie', title: 'Stan pobierania', description: 'Wszystkie skonfigurowane klienty pobierania pogrupowane według Sonarr, Radarr i Lidarr.' }, actions: { refresh: 'Odśwież', clearClientFilter: 'Wyczyść filtr klienta', pause: 'Wstrzymaj', resume: 'Wznów', remove: 'Usuń' }, filters: { client: 'Klient', show: 'Pokaż', activeOnly: 'Tylko aktywne', all: 'Wszystkie', allClients: 'Wszyscy klienci', other: 'Inne', shown: 'Wyświetlono: {count}', hidingCompleted: 'ukończone/seedowane ukryte' }, labels: { clients: 'Klienci', downloadClient: 'Klient pobierania', downloadCount: 'Pobranie: {count}', downloadCount_plural: 'Pobrania: {count}', downSpeed: 'Pobieranie {value}/s', upSpeed: 'Wysyłanie {value}/s', matchedFromArrQueue: 'Dopasowano z kolejki Arr' }, status: { activeDownloads: 'Aktywne pobierania', downloads: 'Pobierania', unknown: 'Nieznane' }, empty: { noClients: 'Brak klientów pobierania skonfigurowanych w Ustawieniach.', noFilterResults: 'Brak pobrań dla tego filtra.' }, upload: { title: 'Dodaj torrent', subtitle: 'Wyślij URL, magnet lub plik do skonfigurowanego klienta', client: 'Klient', category: 'Kategoria', torrentUrl: 'URL torrenta lub Magnet', torrentFile: 'Plik torrent', noCategory: 'Brak kategorii', sending: 'Wysyłanie…', add: 'Dodaj torrent' }, errors: { loadFailed: 'Nie udało się wczytać pobrań', actionFailed: 'Nie udało się wykonać akcji „{action}” dla pobrania', chooseClient: 'Najpierw wybierz klienta pobierania.', missingSource: 'Dodaj URL torrenta, link magnet lub plik torrent.', addFailed: 'Nie udało się dodać torrenta' }, confirm: { remove: 'Usunąć „{name}” z {client}? Pobrane pliki pozostaną na miejscu, jeśli klient to obsługuje.' } },
    calendar: {
