...
export const SETTINGS_INDEX: SettingsIndexEntry[] = [
    ...
    { id: 'request/request-permissions', tabId: 'request', sectionId: 'request-permissions', label: 'Request Permissions', labelKey: 'settings.search.entries.requestPermissions', group: 'Media Stack', keywords: ['permissions', '4k', 'advanced', 'watchlist', 'recently added'] },
