...
export const SETTINGS_INDEX: SettingsIndexEntry[] = [
    ...
    { id: 'mediastack/download-clients', tabId: 'mediastack', sectionId: 'download-clients', label: 'Download Clients', group: 'Media Stack', keywords: ['downloads', 'qbittorrent', 'rdt-client', 'real-debrid', 'transmission', 'bittorrent', 'deluge', 'sabnzbd', 'nzbget', 'nzb', 'torrents'] },
    ...
    { id: 'mediastack/jellystat', tabId: 'mediastack', sectionId: 'jellystat', label: 'Jellyfin Analytics', group: 'Media Stack', keywords: ['jellystat', 'jellyglance', 'jellyfin', 'analytics'] },
    ...
    { id: 'notifications/scanner', tabId: 'notifications', sectionId: 'notifications-scanner', label: 'Scanner Notifications', group: 'Comms', keywords: ['scanner', 'deleted', 'upgrade', 'import', 'grab', 'grabbed', 'sonarr', 'radarr', 'lidarr'] },
