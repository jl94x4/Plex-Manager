...
export const SETTINGS_INDEX: SettingsIndexEntry[] = [
    ...
    { id: 'notifications/scanner', tabId: 'notifications', sectionId: 'notifications-scanner', label: 'Scanner Notifications', group: 'Comms', keywords: ['scanner', 'deleted', 'upgrade', 'import', 'sonarr', 'radarr', 'lidarr'] },
