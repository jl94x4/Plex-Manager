...
export const SETTINGS_INDEX: SettingsIndexEntry[] = [
    ...
    { id: 'request/request-permissions', tabId: 'request', sectionId: 'request-permissions', label: 'Request Permissions', labelKey: 'settings.search.entries.requestPermissions', group: 'Media Stack', keywords: ['permissions', '4k', 'advanced', 'tags', 'watchlist', 'recently added'] },
    ...
    { id: 'system/maintenance', tabId: 'system', sectionId: 'maintenance', label: 'Cleaner Experimental Mode', labelKey: 'settings.search.entries.cleanerExperimentalMode', group: 'Automation', keywords: ['cleaner', 'maintenance', 'experimental'] },
