...
Admins can see active streams in real time with user identity, media title, playback progress, stream type, and technical playback details such as codecs, bitrate, resolution, and transcode reason.
